...
export const ProfileNav = ({ _id, id, display, setDisplay, changeDisplay }) => {
  return (
    ...
    after:w-1/2 after:h-1 after:bg-slate-900 after:absolute after:bottom-0 after:left-0 ${display == 'sippets' ? '' : display == 'comments' ? 'after:translate-x-[100%]' : 'after:translate-x-[200%]'} after:duration-300`}>
